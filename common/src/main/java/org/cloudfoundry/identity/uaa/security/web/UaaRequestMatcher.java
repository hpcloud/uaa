...
public final class UaaRequestMatcher implements RequestMatcher {
    ...
    private boolean matchesHeader(String requestValue, List<String> expectedValues) {
        for (String headerValue : expectedValues) {
            if (requestValue == null || !requestValue.startsWith(headerValue)) {
                return false;
            }
        }
        return true;
    ...
    public boolean equals(Object obj) {
        ...
        if (!((this.accepts == null && other.accepts == null) ||
            (this.accepts != null && this.accepts.equals(other.accepts)))) {
            return false;
        }

        if (!((this.expectedHeaders == null && other.expectedHeaders == null) ||
            (this.expectedHeaders != null && this.expectedHeaders.equals(other.expectedHeaders)))) {
            return false;
        }
